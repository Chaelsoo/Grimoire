...
<Tabs>
  ...
  <Tab title="NT Hash">
    ...
    # Include deleted/tombstoned objects in the writable results
    bloodyAD -u $USER -p "00000000000000000000000000000000:$NTHASH" -d $DOMAIN --host $DC_HOST get writable --include-del
    ```
  </Tab>
  <Tab title="Kerberos">
    ```bash wrap
    ...
    # Include deleted/tombstoned objects in the writable results
    bloodyAD -k ccache=/tmp/ticket.ccache -d $DOMAIN --host $DC_HOST get writable --include-del
    ```
  </Tab>
</Tabs>
