...
# Through a local port-forward (e.g. ssh -L 3389:172.19.0.2:3389), with a mounted drive
xfreerdp3 /v:127.0.0.1 /u:$USER /p:$PASSWORD /sec:tls /cert:ignore \
  /dynamic-resolution /drive:share,$LOCAL_DIR
