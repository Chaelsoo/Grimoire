...
- [Web Information Gathering](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/web-information-gathering.md)
- [Subdomain Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/subdomain-enumeration.md)
- [Web Application Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/web-application-enumeration.md)
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration.md?ask=<question>
```
...
### **🌐** [**Subdomain Enumeration & DNS Discovery**](/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/subdomain-enumeration.md)
...
1. **Start with** [Subdomain Enumeration](/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/subdomain-enumeration.md) to understand DNS infrastructure
2. **Progress to** [Web Application Enumeration](/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/web-application-enumeration.md) for application-level discovery
...
* [Service-Specific Enumeration](https://github.com/kabaneridev/oscp-notes/blob/main/CPTS-PREP/services/README.md)
* [Database Enumeration](https://github.com/kabaneridev/oscp-notes/blob/main/CPTS-PREP/databases/README.md)
* [Remote Management](https://github.com/kabaneridev/oscp-notes/blob/main/CPTS-PREP/remote-management/README.md)
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/web-information-gathering.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/subdomain-enumeration.md?ask=<question>
```
...
| `-w`   | dirb\_common.txt | Path to wordlist                     |
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/web-enumeration/web-application-enumeration.md?ask=<question>
```
