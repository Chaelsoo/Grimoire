...
- [FTP Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/ftp-enumeration.md)
- [SMB Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/smb-enumeration.md)
- [NFS Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/nfs-enumeration.md)
- [SMTP Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/smtp-enumeration.md)
- [Email Services (IMAP/POP3)](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/email-enumeration.md)
- [SNMP Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/snmp-enumeration.md)
- [IPMI Enumeration](https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/ipmi-enumeration.md)
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/ftp-enumeration.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/smb-enumeration.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/nfs-enumeration.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/smtp-enumeration.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/email-enumeration.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/snmp-enumeration.md?ask=<question>
```
...
```
GET https://kabaneridev.gitbook.io/pentesting-notes/certification-preparation/cpts-prep/network-services/ipmi-enumeration.md?ask=<question>
```
