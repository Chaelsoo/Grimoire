...
<Frame caption="ACL abuse mindmap">
  <img src="/images/acl-mindmap.png" alt="ACL abuse mindmap" style={{background: "white", padding: "16px", borderRadius: "8px"}} />
</Frame>

<Frame caption="DACL abuse attack paths by right and object type">
  <img src="/images/dacl-abuse-mindmap.png" alt="DACL abuse mindmap showing attack paths for GenericAll, GenericWrite, WriteDACL, AllExtendedRights, and WriteOwner across Group, User, Computer, Domain Object, AdminSD Holder, Group Policy, and Security Descriptor" />
</Frame>
