...
# getTGT.py: saves to a named file, set KRB5CCNAME after
...
# List shares then connect
# shares
# use Finance
# ls

# Native smbclient
smbclient -k //DC_HOST/Finance -c 'ls'

# nxc: use --use-kcache (reads KRB5CCNAME) + FQDN mandatory
...
# KRB5CCNAME must be set; evil-winrm picks it up automatically
```
