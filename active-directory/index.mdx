...
<CardGroup cols={2}>
  ...
  <Card title="AD PowerShell Module" icon="terminal" href="./ad-module">
    Native Get-AD* / Set-AD* cmdlets: users, groups, service accounts, objects, domain — no external tools
  </Card>
