...
<CardGroup cols={2}>
  <Card title="Enumeration" icon="search" href="./enumeration">
  ...
  <Card title="Pass Attacks" icon="arrow-right-left" href="./pass-attacks">
    PTH, PTT, Overpass-the-Hash, Pass-the-Certificate: authenticate without cracking
  </Card>
  <Card title="ACL Abuse" icon="shield-alert" href="./acl-abuse">
  ...
  <Card title="Trusts" icon="git-branch" href="./trusts">
